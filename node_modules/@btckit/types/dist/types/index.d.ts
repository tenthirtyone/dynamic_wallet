...
export type BtcKitMethodMap = DefineGetInfoMethod & DefineGetAddressesMethod & DefineSignPsbtMethod & DefineSignMessageMethod & DefineSendTransferMethod;
...
export interface BtcKitRequestFn {
    <T extends BtcKitMethodNames>(arg: T, params?: object | string[]): Promise<BtcKitMethodMap[T]['response']>;
}
